...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \textit{Priority/Phase-in date:} High/Jan 17; Although this is a core functionality for the system, its implementation depends on the successful implementation of several other requirements, thus will be properly implemented at a later time.
  \end{itemize}
...
\begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item \textit{Priority/Phase-in date:} Medium/Jan 17; Although this is a core functionality for the system, its implementation depends on the successful implementation of many other requirements and thus will be implemented at a later time.
    \end{itemize}
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \textit{Priority/Phase-in date:} Low/March 21; As this is part of the stretch goals for the system, its implementation will not be considered until all higher priority requirements are satisfied.
  \end{itemize}
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \textit{Priority/Phase-in date:} Low/March 21; As this is part of the stretch goals for the system, its implementation will not be considered until the higher priority requirements are satisfied.
  \end{itemize}
\end{enumerate}
